...
int main(int argc, char* argv[]) {
    ...
    bool verbose = reader.GetBoolean("general", "verbose", 3072);
    ...
    std::cout <<"Sizes : " << demo.sizes() << std::endl;
    ...
    std::cout <<"Sizes : " << interpolated_tensor.sizes() << std::endl;
    ...
    ///////////////////////////////////////////////////////////////////////// beamforming
    // it requires precomputed distance
    std::cout << distpath << std::endl;
    std::ifstream file(distpath);
    if (!file) {
        std::cerr << "File not found: " << distpath << std::endl;
    ...
    std::cout << distmat.size(0) << " " << distmat.size(1) << std::endl;
    ...
    std::cout << beamformed.sizes() << std::endl;
